...
| 2026-04-08 | Signup → paid conversion funnel (CFO item #5) — subscription_cancelled_monthly/annual events fired on customer.subscription.deleted webhook; countEventsByTypeInLastNDays query; AnalyticsDashboardResponse extended with ARPU, LTV, monthly churn rate, churn by plan (30d), new-paid-30d; Revenue & Retention panel added to admin analytics tab |
